...
const UserProfilePage = () => {
  ...
  const fetchFollowers = async () => {
    const token = localStorage.getItem("access");
    try {
       // If userId is undefined or matches the logged-in user, fetch their own followers
      const idToFetch = userId ? userId : userprofile_id;
      
      // const response = await axios.get(`${baseURL}/post/followers/${userId}/`, {
        const response = await axios.get(`${baseURL}/post/followers/${idToFetch}/`, {
  ...
  const fetchFollowing = async () => {
    ...
    try {
      ...
      // const response = await axios.get(`${baseURL}/post/following/${userId}/`, {
        const response = await axios.get(`${baseURL}/post/following/${idToFetch}/`, {
